...
from puntaje import *
import pygame,sys
def Nivel_1(): #contiene todo el nivel 1
    pygame.init()
    ...
    color_activo = NEGRO
    color = color_activo
    guardado = False  # Variable para controlar si ya se han guardado los puntos

    
    pantalla = pygame.display.set_mode((ANCHO_PANTALLA,ALTO_PANTALLA))
    fondo = pygame.image.load("imagenes/fondos/fondo_nivel_1.png")
    ...
    #MUSICA
    pygame.mixer.music.load("D:/Archivos/juego_parcial/musica/Touhou Rumias Theme Apparitions Stalk the Night (Metal Mix).mp3")
    ...
    personaje = Personaje((25,25),(2,434),diccionario_animaciones,7,30,10,10)

    #DICCIONARIO ANIMACIONES ENEMIGO
    diccionario_animaciones_enemigo = {}
    diccionario_animaciones_enemigo["correr_derecha"] = lista_enemigo_derecha
    diccionario_animaciones_enemigo["correr_izquierda"] = lista_enemigo_izquierda
    diccionario_animaciones_enemigo["recibir_daño"] = lista_enemigo_recibir_daño


    #ENEMIGOS
    enemigo_1 = Enemigo((30,30),(350,52),diccionario_animaciones_enemigo,550,2,3,1)
    enemigo_2 = Enemigo((30,30),(606,226),diccionario_animaciones_enemigo,765,2,3,1)
    enemigo_3 = Enemigo((30,30),(352,265),diccionario_animaciones_enemigo,530,2,3,1)
    enemigo_4 = Enemigo((30,30),(12,210),diccionario_animaciones_enemigo,185,2,3,1)
    ...
    #ITEMS
    item_1 = Item((30,30),(136,164),"imagenes/items_nivel_1/carne.png")
    item_2 = Item((30,30),(375,242),"imagenes/items_nivel_1/carne.png")
    item_3 = Item((30,30),(534,44),"imagenes/items_nivel_1/carne.png")
    item_4 = Item((30,30),(660,188),"imagenes/items_nivel_1/carne.png")
    item_5 = Item((30,30),(639,410),"imagenes/items_nivel_1/carne.png")
    item_6 = Item((30,30),(242,372),"imagenes/items_nivel_1/carne.png")
