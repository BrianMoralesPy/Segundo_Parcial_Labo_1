...
from puntaje import *
import pygame,sys
def Nivel_3() -> None: #contiene todo el nivel 3
    ...
    fondo = pygame.image.load("imagenes/fondos/fondo_nivel_3.jpg")
    ...
    #MUSICA
    pygame.mixer.music.load("musica\[] Kaos Final Boss - Part 5  Skylanders Trap Team Music.mp3")
    ...
    diccionario_animaciones_enemigo["correr_derecha"] = lista_enemigo_derecha_3
    diccionario_animaciones_enemigo["correr_izquierda"] = lista_enemigo_izquierda_3
    diccionario_animaciones_enemigo["recibir_daño"] = lista_enemigo_recibir_daño_3


    #ENEMIGOS
    enemigo_1 = Enemigo((50,50),(350,35),diccionario_animaciones_enemigo,550,6,6,1)
    enemigo_2 = Enemigo((50,50),(606,210),diccionario_animaciones_enemigo,765,6,6,1)
    enemigo_3 = Enemigo((50,50),(352,350),diccionario_animaciones_enemigo,530,6,6,1)
    enemigo_4 = Enemigo((50,50),(12,195),diccionario_animaciones_enemigo,185,6,6,1)
    lista_enemigos = [enemigo_1,enemigo_2,enemigo_3,enemigo_4]
    #PLATAFORMAS
    piso = Plataforma((800,50),(0,523),"imagenes\plataformas\piso_invisible.png")
    plataforma_1 = Plataforma((200,50),(4,241),"imagenes\plataformas\plataforma_2.png")
    plataforma_2 = Plataforma((200,50),(357,80),"imagenes\plataformas\plataforma_3.png")
    plataforma_3 = Plataforma((200,50),(600,256),"imagenes\plataformas\plataforma_2.png")
    plataforma_4 = Plataforma((200,50),(339,400),"imagenes\plataformas\plataforma_3.png")
    lista_plataformas = [piso,plataforma_1,plataforma_2,plataforma_3,plataforma_4]
    #ITEMS
    item_1 = Item((30,30),(136,164),"imagenes\items_nivel_3\queso.png")
    item_2 = Item((30,30),(375,242),"imagenes\items_nivel_3\queso.png")
    item_3 = Item((30,30),(534,44),"imagenes\items_nivel_3\queso.png")
    item_4 = Item((30,30),(242,372),"imagenes\items_nivel_3\queso.png")
    lista_items = [item_1,item_2,item_3,item_4] 
    ejecutar = True
    while ejecutar:
        reloj.tick(FPS) 
